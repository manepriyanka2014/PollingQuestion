...
//	}
	...
	public ResponseEntity<?>getEmail(
			@ApiParam(value = "please enter the emailId to get user information", required = true) @PathVariable("userEmail") String email){
		System.out.println(" Inside get user email ");
		User user2 = userMapper.getUserByEmailId(email);
